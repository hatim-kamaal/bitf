...
$pdf->AddPage();
$pdf->addSociete( "Burhani IT Fraternity",
                  "(Anjumane-a-Taheri)\n" .
                  "Address line 1\n".
                  "Address Line 2\n" .
                  "Address line 3 " );
$pdf->fact_dev( "Devis ", "TEMPO" );
$pdf->temporaire( "Burhani IT Fraternity" );
$pdf->addDate( "03/12/2003");
$pdf->addClient("CL01");
$pdf->addPageNumber("1");
$pdf->addClientAdresse("Client Address");
$pdf->addReglement("Transaction reference : ");
$pdf->addEcheance("03/12/2003");
$pdf->addNumTVA("FR888777666");
$pdf->addReference("Mr Hatim Kamal");
